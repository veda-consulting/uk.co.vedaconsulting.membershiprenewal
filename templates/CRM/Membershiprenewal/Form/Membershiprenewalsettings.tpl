...
<div class="crm-block crm-form-block crm-dotmailer-mapping-form-block">
	...
	<div class="crm-wizard center" id="gk-msform">
		...
		<fieldset id="first">
			...
			<input type="button" name="Start" class="next_btn" value="Start"/>
		</fieldset>
		<!-- End of first fieldset - welcome-->

		<!-- New Joiners -->
		<fieldset>
			<h2 class="title">New Joiners</h2>
			<p class="subtitle">Step 1</p>
			<h3>Do you want to include new joiner in the communications batch?</h3>
			<div class="crm-section include_new_joiners">
				{$form.include_joiner.label} &nbsp; {$form.include_joiner.html}
				<div class="clear"></div>
			</div>
			...
			<div class="crm-block crm-form-block crm-dotmailer-mapping-list-form-block" id="NewJoinerCommunication">

				<div class="crm-section include_new_joiners">

					{$form.cut_off_date.label} &nbsp; {include file="CRM/common/jcalendar.tpl" elementName=cut_off_date}
		...
		<!-- Yearly fieldset -->
		<fieldset>
			<h3>Does membership renew every year?</h3>
			<p class="subtitle">Step 2</p>

			<div class="crm-section sms_activity_subject">
				{$form.autorenew_payment_instrument_id.label} &nbsp; {$form.autorenew_payment_instrument_id.html}
				<br />
				<span class="description">Select the auto-renew payment methods.
				<br />
				If the membership is linked with a recurring record having the selected payment methods, Auto-renew message templates will be used to send the email or print letters and you will also get the option to auto-renew the membership after the 3rd reminder is sent.
				</span>
				<div class="clear"></div>
			</div>
			<input class="pre_btn" name="previous" type="button" value="Previous">
		...
		<fieldset>
			...
			<h3>When do you send the first renewal reminder out before the membership expires?</h3>
			<div class="crm-section renewal_first_reminder">
		...
		<fieldset>
			...
			<h3>When do you send the second renewal reminder out before the membership expires?</h3>
			<div class="crm-section renewal_second_reminder">
		...
		<fieldset>
			...
			<h3>When do you send the third renewal reminder out before the membership expires?</h3>
			<div class="crm-section renewal_third_reminder">
		...
		<fieldset>
			...
			<h3>Do you send different emails to different membership types?</h3>
		...
		<!-- Enable SMS -->
		<fieldset>
			<h2 class="title">Enable SMS?</h2>
			<p class="subtitle">Step 8</p>
			<h3>Do you want to send SMS to members about the renewal?</h3>
			<div class="crm-section enable_sms">
				{$form.enable_sms.label} &nbsp; {$form.enable_sms.html}
				<br />
			...
			<div class="crm-section sms_activity_subject">
				{$form.sms_activity_subject.label} &nbsp; {$form.sms_activity_subject.html}
				<div class="clear"></div>
			</div>
			<div class="crm-section sms_message">
				<div id='char-count-message'></div>
				{$form.sms_text_message.label} &nbsp; {$form.sms_text_message.html}
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
			<input class="pre_btn" name="previous" type="button" value="Previous">
		...
		<fieldset>
			<h2 class="title">Enable Word Mailmerge?</h2>
			<p class="subtitle">Step 9</p>
			<h3>Do you want to send enable Word Mailmerge for pringint letters?</h3>
			<div class="crm-section enable_sms">
				{$form.enable_word_mailmerge.label} &nbsp; {$form.enable_word_mailmerge.html}
				<br />
...
cj( document ).ready(function() {
	...
	cj('#sms_activity_subject').parent().hide();
	cj('#sms_text_message').parent().hide();
	...
	if (cj('#enable_sms').prop('checked')) {
	    cj('#sms_activity_subject').parent().show();
		cj('#sms_text_message').parent().show();
	} else {
	    cj('#sms_activity_subject').parent().hide();
		cj('#sms_text_message').parent().hide();
	} 
