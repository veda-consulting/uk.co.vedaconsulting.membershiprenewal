...
FROM civicrm_membership WHERE join_date > %1 AND join_date >= %2 AND join_date <= %3 {$extraInclude}
";
      CRM_Core_DAO::executeQuery($sql, $params);
    }
...
AND member.join_date >= %1 AND member.join_date <= %2 AND member.join_date > %3
";
      $selectParams = array(
        '1' => array($firstDate, 'String' ),
        '2' => array($lastDate, 'String' ),
